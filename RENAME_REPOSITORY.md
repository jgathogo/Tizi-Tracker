...
## Current Status
- **Current Repository Name:** `Tizi-Log-Tizi-Tracker`
- **New Repository Name:** `Tizi-Tracker` (recommended)
- **GitHub URL:** https://github.com/jgathogo/Tizi-Log-Tizi-Tracker
...
1. **Go to your repository:**
   - Visit: https://github.com/jgathogo/Tizi-Log-Tizi-Tracker
...
4. **Rename:**
   - Change from: `Tizi-Log-Tizi-Tracker`
...
```bash
cd /home/james/Documents/Tizi-Log-Tizi-Tracker
